...
//         }
//         if (error.error && error.error.startsWith('Compilation Error:')) {
//             return { success: false, verdict: VERDICT.COMPILATION_ERROR, error: error.error };
//         }
//         if (error.error && error.error.startsWith('Runtime Error:')) {
//             return { success: false, verdict: VERDICT.RUNTIME_ERROR, error: error.error };
//         }
//         return { success: false, verdict: VERDICT.RUNTIME_ERROR, error: "Unknown error: " + error.error };
//     }
// };
